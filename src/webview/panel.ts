...
import { LogEntry, LogStats, LogFilters, WebviewMessage } from '../models/types';
...
export class LogViewerPanel {
    ...
    constructor(context: vscode.ExtensionContext, logs: LogEntry[], fileName: string) {
        this.allLogs = [...logs];
    ...
    private updateWebview() {
        ...
        this.currentLogs = this.allLogs.filter(log => {
            ...
            const loggerMatch = !this.filters.logger || log.logger === this.filters.logger;
        ...
        this.panel.webview.html = getWebviewContent(this.currentLogs, stats, this.filters);
    }
}